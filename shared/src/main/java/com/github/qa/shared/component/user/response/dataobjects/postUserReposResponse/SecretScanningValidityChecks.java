...
public class SecretScanningValidityChecks {
    ...
    public String toString() {
        ...
        sb.append(SecretScanningValidityChecks.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SecretScanningValidityChecks) == false) {
            return false;
        }
        SecretScanningValidityChecks rhs = ((SecretScanningValidityChecks) other);
