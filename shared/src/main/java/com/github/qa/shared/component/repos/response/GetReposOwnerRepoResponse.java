package com.github.qa.shared.component.repos.response;
...
@Data
public class GetReposOwnerRepoResponse {
    ...
    public String toString() {
        ...
        sb.append(GetReposOwnerRepoResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetReposOwnerRepoResponse) == false) {
            return false;
        }
        GetReposOwnerRepoResponse rhs = ((GetReposOwnerRepoResponse) other);
